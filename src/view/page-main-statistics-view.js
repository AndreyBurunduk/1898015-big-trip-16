...
import {countTripEventsMoney, countTripEventsQuantityByType, countTripEventsTimeByType, formatChartTime} from '../utils/event.js';
...
export default class PageMainStatisticsView extends SmartView {
  #moneyChart = null;
  #typeChart = null;
  #timeChart = null;
